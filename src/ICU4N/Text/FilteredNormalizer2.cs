    ...
    public partial class FilteredNormalizer2 : Normalizer2
    {
        ...
        public override QuickCheckResult QuickCheck(ICharSequence s)
        {
            ...
            for (int prevSpanLimit = 0; prevSpanLimit < s.Length;)
            {
                ...
                {
                    QuickCheckResult qcResult = norm2.QuickCheck(s.Subsequence(prevSpanLimit, spanLimit - prevSpanLimit)); // ICU4N: Corrected 2nd parameter
                    if (qcResult == QuickCheckResult.No)
                    {
                        return qcResult;
                    }
        ...
        public override int SpanQuickCheckYes(ICharSequence s)
        {
            ...
            for (int prevSpanLimit = 0; prevSpanLimit < s.Length;)
            {
                ...
                {
                    int yesLimit =
                        prevSpanLimit + norm2.SpanQuickCheckYes(s.Subsequence(prevSpanLimit, spanLimit - prevSpanLimit)); // ICU4N: Corrected 2nd parameter
                    if (yesLimit < spanLimit)
                    {
                        return yesLimit;
                    }
