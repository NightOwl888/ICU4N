...
namespace ICU4N.Globalization // ICU4N: Moved from ICU4N.Util namespace
{
    ...
    public static class LocaleIDs // ICU4N specific - marked static, since there are no instance methods or fields
    {
        ...
        private static readonly string[] _replacementLanguages = {
            "id", "he", "yi", "jv", "sr", "nb",/* replacement language codes */
        };

        private static readonly string[] _obsoleteLanguages = {
        ...
        private static readonly string[] _languages3 = {
        ...
        private static readonly string[] _obsoleteLanguages3 = {
            /* "in",  "iw",  "ji",  "jw",  "sh", */
            "ind", "heb", "yid", "jaw", "srp",
        };
        ...
        */
        ...
        private static readonly string[] _deprecatedCountries = {
            "AN", "BU", "CS", "DD", "DY", "FX", "HV", "NH", "RH", "SU", "TP", "UK", "VD", "YD", "YU", "ZR" /* deprecated country list */
        };

        private static readonly string[] _replacementCountries = {
        ...
        private static readonly string[] _obsoleteCountries = {
        ...
        private static readonly string[] _countries3 = {
        /*  "AD",  "AE",  "AF",  "AG",  "AI",  "AL",  "AM",      */
        ...
        private static readonly string[] _obsoleteCountries3 = {
