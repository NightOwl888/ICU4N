...
namespace ICU4N.Impl
{
    public sealed partial class CaseMapImpl
    {
        ...
        private static int AppendCodePoint(IAppendable a, int c)
        {
            if (c <= char.MaxValue)
            {
                a.Append((char)c);
        ...
        private static string ApplyEdits(StringBuilder src, StringBuilder replacementChars, Edits edits)
        {
            if (!edits.HasChanges)
            {
                return src.ToString();
        ...
        private static string ApplyEdits(char[] src, StringBuilder replacementChars, Edits edits)
        {
            if (!edits.HasChanges)
            {
                return src.ToString();
            ...
            StringBuilder dest, Edits edits)
        {
            ...
            {
                c = UCaseProperties.Instance.ToFullLower(c, iter, dest, caseLocale);
            ...
            string src, StringBuilder dest, Edits edits)
        {
            try
            {
                ...
                while ((c = iter.NextCaseMapCP()) >= 0)
                {
                    c = UCaseProperties.Instance.ToFullUpper(c, iter, dest, caseLocale);
                    AppendResult(c, dest, iter.CPLength, options, edits);
                }
                return dest;
            }
                ...
                while (prev < srcLength)
                {
                    ...
                    if (prev < index)
                    {
                        ...
                        if (titleStart < index)
                        {
                            ...
                            c = UCaseProperties.Instance.ToFullTitle(c, iter, dest, caseLocale);
                            AppendResult(c, dest, iter.CPLength, options, edits);
            ...
            string src, StringBuilder dest, Edits edits)
        {
            try
            {
                ...
                for (int i = 0; i < length;)
                {
                    ...
                    i += cpLength;
                    c = UCaseProperties.Instance.ToFullFolding(c, dest, options);
        ...
        private sealed partial class GreekUpper
        {
            ...
            private static bool IsFollowedByCasedLetter(string s, int i)
            {
                while (i < s.Length)
                {
            ...
            private static bool IsFollowedByCasedLetter(StringBuilder s, int i)
            {
                while (i < s.Length)
                {
                    int c = Character.CodePointAt(s, i);
            ...
            private static bool IsFollowedByCasedLetter(char[] s, int i)
            {
                while (i < s.Length)
                {
                    int c = Character.CodePointAt(s, i);
                ...
                string src, StringBuilder dest, Edits edits)
            {
                ...
                for (int i = 0; i < src.Length;)
                {
                    ...
                    {
                        c = UCaseProperties.Instance.ToFullUpper(c, null, dest, CaseLocale.Greek);
