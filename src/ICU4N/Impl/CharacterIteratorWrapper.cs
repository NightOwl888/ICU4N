...
namespace ICU4N.Impl
{
    ...
    /// </summary>
    /// <author>ram</author>
    internal class CharacterEnumeratorWrapper : UCharacterIterator // ICU4N TODO: API Changed from public to internal until UCharacterIterator can be converted into an enumerator
    {
