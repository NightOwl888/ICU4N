...
namespace Microsoft.Extensions.Primitives
{
    ...
    /// </summary>
    internal static class ChangeToken
    {
        /// <summary>
        ...
        private sealed class ChangeTokenRegistration<TState> : IDisposable
        {
            ...
            private static readonly NoopDisposable Comparand = new NoopDisposable();
            ...
            private void SetDisposable(IDisposable disposable)
            {
                ...
                // disposable.
                IDisposable? current = Interlocked.CompareExchange(ref _disposable, Comparand, Comparand); //Volatile.Read(ref _disposable);
