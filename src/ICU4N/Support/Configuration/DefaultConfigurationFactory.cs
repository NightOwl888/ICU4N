...
namespace ICU4N.Configuration
{
    ...
    {
        private const string ConfigurationPrefix = "icu4n:";
        ...
        public IConfiguration GetConfiguration()
        {
            return LazyInitializer.EnsureInitialized(ref this.configuration,
                () => new ConfigurationRoot(new IConfigurationProvider[] {
                    ...
                    new ConfigurationManagerConfigurationProvider(prefix: ConfigurationPrefix, ignoreConfigurationExceptionsOnRead: true),
#endif
                }));
        }
    }
