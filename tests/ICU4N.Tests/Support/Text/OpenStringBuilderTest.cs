...
namespace ICU4N.Text
{
    public class OpenStringBuilderTest
    {
        ...
        {
            var vsb = new OpenStringBuilder(); //default(ValueStringBuilder);
        ...
        //{
        //    var vsb = new OpenStringBuilder(new char[1]); // new ValueStringBuilder(new char[1]);
        //    Assert.AreEqual(0, vsb.Length);
        ...
        {
            var vsb = new OpenStringBuilder(1);
            Assert.AreEqual(0, vsb.Length);
        ...
        public void Append_String_Large_MatchesStringBuilder(int initialLength, int stringLength)
        {
            ...
            var vsb = new OpenStringBuilder(initialLength);
        ...
        public void TryCopyTo_FailsWhenDestinationIsTooSmall_SucceedsWhenItsLargeEnough()
        {
            ...
            //Assert.AreEqual(0, vsb.Length); // OpenStringBuilder doesn't Dispose() the array when the value is copied.
        }
        ...
        public void EnsureCapacity_IfRequestedCapacityWins()
        {
            ...
            var builder = new OpenStringBuilder(32);
        ...
        public void EnsureCapacity_NoAllocIfNotNeeded()
        {
            // Note: constants used here may be dependent on minimal buffer size
            // the ArrayPool is able to return.
            var builder = new OpenStringBuilder(64);
        ...
        {
            var sb = new OpenStringBuilder(16);
            sb.Append("foo bar");
        ...
        public void Test_Append_String()
        {
            ...
            Assert.AreEqual("", sb.ToString()); // J2N: Changed the behavior to be a no-op rather than appending the string "null"
        }
        ...
        private void reverseTest(string org, string rev, string back)
        {
            ...
            var sb = new OpenStringBuilder(32);
            sb.Append(org);
            sb.Reverse();
        ...
        public void Test_IndexOf_String_CultureSensitivity()
        {
            ...
            var sb = new OpenStringBuilder(fixture);
